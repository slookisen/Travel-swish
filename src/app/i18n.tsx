...
export const UI_COPY = {
  no: {
    ...
    results: {
      personal: 'PERSONLIG UTVALG', food: 'MAT OG DRIKKE', experiences: 'OPPLEVELSER',
      ...
      officialSource: 'Offisiell kilde ↗', mapsSearch: 'Søk i kart ↗', openPlace: 'Åpne sted ↗', sourceLink: 'Åpne kilde ↗',
  ...
  en: {
    ...
    results: {
      personal: 'PERSONAL SELECTION', food: 'FOOD AND DRINK', experiences: 'EXPERIENCES',
      ...
      officialSource: 'Official source ↗', mapsSearch: 'Search in Maps ↗', openPlace: 'Open place ↗', sourceLink: 'Open source ↗',
