...
NOTE: Pure algorithm helpers live in app/algo.py so we can import them here
without importing FastAPI/SQLite.
"""
...
class TestDirectionDetection:
    ...
    def test_explicit_dir_positive(self):
        ...
        assert detect_direction({"dir": 1}, "") == 1.0
...
class TestScoringIntegration:
    """Integration tests for the (documented) scoring math."""
